...
`pairwise_test_bin`, `pairwise_test_cont`, `pairwise_test_cor` are functions
that perform pairwise group (or any categorical variable) comparisons. The
function will go through all pairwise comparisons and output descriptive
