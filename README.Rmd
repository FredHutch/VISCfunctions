...
The package provides functions for common tasks for creating statistical reports at VISC.  The goal of VISCfunctions is to:
...
for Vaccine Immunology Statistical Center (VISC) statisticians and programmers at Fred Hutch.
...
Below is an overview of the currently availble functions in VISCfunctions.
