...
- [`escape()`](https://fredhutch.github.io/VISCfunctions/reference/escape.md)
  : Protect control characters in a string for use in a latex table or
  caption
- [`exampleData_BAMA`](https://fredhutch.github.io/VISCfunctions/reference/exampleData_BAMA.md)
  : Example BAMA dataset
- [`exampleData_ICS`](https://fredhutch.github.io/VISCfunctions/reference/exampleData_ICS.md)
  : Example ICS dataset
- [`exampleData_NAb`](https://fredhutch.github.io/VISCfunctions/reference/exampleData_NAb.md)
  : Example NAb dataset
...
- [`stat_paste()`](https://fredhutch.github.io/VISCfunctions/reference/stat_paste.md)
  : Rounds and combines up to three numbers into table friendly
  presentation
...
- [`wilson_ci()`](https://fredhutch.github.io/VISCfunctions/reference/wilson_ci.md)
  **\[superseded\]** : Wilson Confidence Interval
